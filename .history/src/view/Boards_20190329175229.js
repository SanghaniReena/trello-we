    ...
    boardData=this.props.boardData.map((boardData, key) => {
      return (
        ...
        <div className="col-sm-4" style={{ padding: "7px", width: "100%" }} key={key}>
          <Card onMouseOver={style={backgroundColor:"white"}} onClick={() => this.handleOnclickCard(boardData.idboards)} body outline color="secondary" style={{ width: "80%", backgroundColor: "lightcyan" ,}} >
