    ...
    render() {
      ...
      let singleCard=[]
        ...
        return (
                ...
                <Modal style={{minHeight:"600px"}} open={this.props.open} onClose={this.props.onClose} idcards={this.props.idcards} center>
                <br></br>
                    <div className="cmMainDiv" style={{minHeight:"600px"}}>
                    <div >
                        {(singleCard.length>0)?
                        singleCard[0].cTitle:""
                        }
