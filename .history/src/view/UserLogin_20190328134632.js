...
class UserLogin extends Component {
      ...
      validateField(fieldName, value) {
        ...
        switch (fieldName) {
            case 'eamil':
                ...
                fieldValidationErrors.firstName = fieldValidation.email ? '' : ' Only Alphabets Allow';
                break;

            case 'pw':
                fieldValidation.lastName = /^[a-zA-Z 0-9]+$/.test(value);
                fieldValidationErrors.lastName = fieldValidation.pw ? '' : ' Only Alphabets Allow'
                break;
    ...
    validateForm() {
        this.setState({
            formValid: this.state.fieldsValid.email &&
