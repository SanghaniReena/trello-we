                ...
                <Modal open={this.props.open} onClose={this.props.onClose} idcards={this.props.idcards} center>
                   ...
                   <div >
                    ...
                    <div>
                        ...
                        <form>
                        <div className="commDiv"><textarea type="text" placeholder="Write a comment…" min="1" style={{borderColor: "lightgrey" ,minWidth:"500px",minHeight:"60px"}}/></div>
                        <button style={{marginBottom:"1%", backgroundColor: "#5aac44",boxShadow:"0 1px 0 0 #3f6f21",border:"none",color: "#fff",fontWeight:"bold",borderRadius:"6%",padding:"0.5% 1.5%"}}>{" "}Save{" "} </button>
                        </form>
                    </div>
                    <div>
                        <div className="cmTitle" >Activity</div>
