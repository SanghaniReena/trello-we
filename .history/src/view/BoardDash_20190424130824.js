...
class BoardDash extends Component {
  ...
  handleClickOnCard=(idcards)=>{

    this.props.history.push("/"+idcards+"/cards")
  }
  render() {
              ...
              if (listData.idlist === cardData.idlists) {
                return (
                  <div key={key}
                    ...
                    draggable
                    className="draggable"
                    onDrop={(e) => this.onDrop(e, cardData.cTitle)} onClick={()=>this.handleClickOnCard(cardData.idcards)} >
    ...
    return (
      <div>
        <Navbd></Navbd>
        <Cards isOpen={this.state.isopenCM} toggle={this.state.toggleCM}></Cards>
