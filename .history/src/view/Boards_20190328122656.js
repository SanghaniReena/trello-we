...
class Boards extends Component {
    ...
    render() {
        ...
        return (
            ...
            <center>
                <div  ><h4 style={{padddin:"15px",color: "cornflowerblue"}}>Personal Boards</h4></div>
            <div className="row" style={{padding:"15px", margin:"auto",width:"100%"}}>
                {this.props.boardData.map((boardData,key)=>{
                return (
                    <div className="col-sm-4" style={{padding:"5px",width:"100%"}}>
                    <Card body outline color="secondary"  style={{width:"80%"}} key>
